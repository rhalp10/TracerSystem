...
<li class="active"><a href="register_student.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Register Student</a></li>
        
        <li class=""><a href="add_announcement.php"><i class="icon-chevron-right"></i><img src="img/megaphone.png" width="15" height="15" />&nbsp;Post Announcement</a></li> 
