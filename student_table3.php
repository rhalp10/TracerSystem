	...
	while ($row = mysql_fetch_array($query)) {
		...
		<td width="100"><?php echo $row['department'] . " , " . $row['class_name']; ?></td> 
	
		<td width="50"><a href="teacher_portal_view.php<?php echo '?id='.$id; ?>" class="btn btn-success"><img src="img/search.png" width="15" height="15" /> View Info</a></td>
