                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="control-group">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input name="middlename" class="input focused" id="focusedInput" type="text" placeholder = "Middlename" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="address" class="input focused" id="focusedInput" type="text" placeholder = "Address" required>
                                          </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                          <div class="controls">
                                            <input  name="bday" class="input focused" id="focusedInput" type="date" placeholder = "Birthdate" required>
                                          </div>
                                        </div>   
                                      ...
                                      <label>Department</label>
                                          <div class="controls">
                                            <select  name="department" class="" required>
                                             	<option></option>
											<?php
											$cys_query = mysql_query("select * from department order by department_id");
                                       ...
                                       <label>School Year Admitted</label>
                                          <div class="controls">
                                            <select  name="admit" class="" required>
                                             	<option></option>
											<?php
                                    ...
                                    <label>School Year Graduated</label>
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
											<center>	<button name="save" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Register Student</button></center>
				...
				$("#add_student").submit(function(e){
					...
					$.ajax({
						...
						success: function(html){
							...
							$('#studentTableDiv').load('student_table2.php', function(response){
