<div class="span3" id="sidebar">
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li class="active"><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Batchmates</a></li>
			<li class="">
			...
			<li class=""><a href="portal_student.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Portal</a></li>
            
            <li class=""><a href="forum_student.php"><i class="icon-chevron-right"></i><i class="icon-pencil"></i>&nbsp;Forum</a></li>
              <li class=""><a href="portal_student.php"><i class="icon-chevron-right"></i><img src="img/statistics.png" width="15" height="15" />&nbsp; Statistics</a></li>
